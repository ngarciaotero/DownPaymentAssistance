...
class UserInformationForm(forms.Form):
    ...
    is_female_head_of_household = forms.BooleanField(required=False, label='Check if you're a female head of household')
    is_PEN = forms.BooleanField(required=False, label='Check if you're a public employee, first responder, nurse or educator')
